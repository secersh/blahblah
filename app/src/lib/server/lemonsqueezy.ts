      ...
      data: {
        ...
        attributes: {
          ...
          checkout_options: {
            ...
            headings_color: '#11100d',
            primary_text_color: '#11100d',
            secondary_text_color: '#4b463f',
            links_color: '#11100d',
            borders_color: '#11100d',
            checkbox_color: '#ff4fb8',
            active_state_color: '#ffe34f',
            button_color: '#ff4fb8',
            button_text_color: '#11100d',
            terms_privacy_color: '#4b463f'
          },
          checkout_data: {
            email: email ?? '',
            custom: {
